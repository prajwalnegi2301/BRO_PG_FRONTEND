    ...
    <div>
          ...
          <ul className="flex justify-around font-semibold text-green-500 text-2xl  ">
            <Link to="/choose">
              ...
              <motion.div className="" whileHover={{ scale: 1.2 }}>
                ...
                <li className="hover:text-green-600  ">Why Choose Us?</li>
              </motion.div>
            </Link>
            ...
            <Link to="/journey">
              ...
              <motion.div className="" whileHover={{ scale: 1.2 }}>
                ...
                <li className="hover:text-green-600">Journey</li>
              </motion.div>
            </Link>
            ...
            <Link to="/programs">
              ...
              <motion.div className="" whileHover={{ scale: 1.2 }}>
                ...
                <li className="hover:text-green-600">Programs</li>
              </motion.div>
            </Link>
          </ul>
        </nav>
      ...
      <div className="bg-blue-100 min-h-screen">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center py-12">
          <div className="bg-white hover:bg-slate-50 rounded-lg shadow-md m-4 w-full md:w-1/2 p-6">
            <h1 className="text-3xl font-bold mb-4">
              Who I <span className="text-blue-500 hover:text-4xl">Am?</span>
        ...
        <div className="flex flex-col md:flex-row-reverse items-center justify-center py-12">
          <div className="bg-white hover:bg-slate-50 rounded-lg shadow-md m-4 w-full md:w-1/2 p-6">
            <h1 className="text-3xl font-bold mb-4">
              Why only <span className="text-blue-500 hover:text-4xl">BRO PG?</span>
            </h1>
            <p className="mb-4 text-gray-700">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center py-12">
          <div className="bg-white hover:bg-slate-50 rounded-lg shadow-md m-4 w-full md:w-1/2 p-6">
            <h1 className="text-3xl font-bold mb-4">
              ...
              <span className="text-blue-500 hover:text-4xl">You</span>
            </h1>
            <p className="mb-4 text-gray-700">
